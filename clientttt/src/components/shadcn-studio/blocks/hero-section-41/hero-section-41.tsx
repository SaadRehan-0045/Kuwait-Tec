      ...
      <div className='mx-auto flex h-full max-w-7xl flex-col gap-16 px-4 sm:px-6 lg:px-8'>
        ...
        <div className='grid grid-cols-1 gap-6 gap-y-12 md:gap-y-16 lg:grid-cols-5'>
          <div className='flex w-full flex-col justify-center gap-5 max-lg:items-center lg:col-span-3 lg:h-95.5'>
           ...
           Welcome to Kuwait Tec — where every shopper belongs.
From trending styles to trusted staples, we bring you choices that suit every taste, every need, and every wallet.
            </p>
            ...
            <div className='flex items-center gap-4'>
              ...
              >
                <a href='#'>
                  Order now
                  <HugeiconsIcon icon={ArrowRight02Icon} strokeWidth={2} className='transition-transform duration-200 group-hover:translate-x-0.5' />
                </a>
              </Button>
              {/* <Button
                size='lg'
